...
public class TaxPaid {
    public static class Map extends MapReduceBase
        ...
        public void map(LongWritable key, Text value,
            ...
            // The column 5 is whether the an employee has paid the tax
            // Mapping yes to readable value
            String taxPaid = data[4].equalsIgnoreCase("YES")
                    ? "Tax Paid"
                    : "Did not paid tax";

            // Collecting the output
            output.collect(new Text(taxPaid), one);
